...
const SingleEventPage = () => {
	return <div className="container">
		...
		<h1 className={styles.title}>Центр Чистой Природы 12-15 приглашает на арт-субботник "Чистая осень"</h1>
		...
		<div className={styles.calendar}>
			...
			Добавить в календарь: iOS  Google</div>
	</div>;
};
