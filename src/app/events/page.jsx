		...
		<div className={styles.container}>
			<div className={styles.eventText}>
				<div className={styles.eventText1}>
					...
					<button className={styles.eventText1_2}>
						Мастер-класс
					</button>
				...
				<div className={styles.eventText2}>
					<button className={styles.eventText2_1}>
						Мастер-класс
					</button>
					<button className={styles.eventText2_2}>
						Мастер-класс
					</button>
					<button className={styles.eventText2_3}>
						Мастер-класс
					</button>
					<button className={styles.eventText2_4}>
						Мастер-класс
					</button>
					<button className={styles.eventText2_5}>
						Мастер-класс
					</button>
					<button className={styles.eventText2_6}>
						Мастер-класс
					</button>
					<button className={styles.eventText2_7}>
						Мастер-класс
					</button>
					<button className={styles.eventText2_8}>
						Мастер-класс
					</button>
				</div>
				<div className={styles.eventText3}>
					<p className={styles.eventText3_1}>Где проходит</p>
					<button className={styles.eventText3_2}>
						Мастер-класс
					</button>
					<button className={styles.eventText3_3}>
						Мастер-класс
					</button>
					<button className={styles.eventText3_4}>
						Мастер-класс
					</button>
					<button className={styles.eventText3_5}>
						Мастер-класс
					</button>
					<button className={styles.eventText3_6}>
						Мастер-класс
					</button>
					<button className={styles.eventText3_7}>
						Мастер-класс
					</button>
				</div>
